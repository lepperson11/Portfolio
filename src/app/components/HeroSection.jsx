      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          {/* <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lf:text-xl">
            ...
            voluptates et quam vero rem perspiciatis aliquam aperiam molestiae.
            Consequuntur laudantium accusantium voluptate quam alias quod
            mollitia debitis hic cupiditate quae.
          </p> */}
          <div>
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:y-[400px] relative">
            <Image
